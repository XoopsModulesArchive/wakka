...
if ($this->HasAccess('write') && $this->HasAccess('read')) {
    ...
    if (_PREVIEW == $_POST['submit']) {
        $previewButtons = '<input name="submit" type="submit" value="' . _SUBMIT . "\" accesskey=\"s\">\n" . '<input name="submit" type="submit" value="' . _EDIT . "\" accesskey=\"p\">\n" . '<input type="button" value="' . _CANCEL . "\" onClick=\"document.location='" . $this->href(
            ''
        ) . "';\">\n";
