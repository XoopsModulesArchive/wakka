...
if ($xoopsUser) {
    ...
    $xoopsConfig['isadmin'] = false;

    $xoopsConfig['uname'] = _GUESTS;

    $xoopsConfig['groups'] = [];
}
$xoopsConfig['navheader'] = $xoopsModuleConfig['header'];
$xoopsConfig['createpem'] = $moduleConfig['createpem'];
$xoopsConfig['writepem'] = $moduleConfig['writepem'];
$xoopsConfig['commentspem'] = $moduleConfig['commentspem'];
...
$GLOBALS['xoopsOption']['template_main'] = 'wakka_item.html';
$xoopsTpl->assign('story', $wakka->template);
